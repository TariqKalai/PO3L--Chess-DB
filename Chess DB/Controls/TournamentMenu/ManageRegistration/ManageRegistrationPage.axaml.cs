...
{
    public partial class ManageRegistrationPage : UserControl
    {

        //or create a page but get the same datacontext to shares variable
        public ManageRegistrationPage(ManageRegistrationViewModel viewModel)
        {
            InitializeComponent();
